...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            // 아아디 찾기
            $("#bthSearchUserId").on("click", function () { // 버튼 클릭했을때, 발생되는 이벤트 생성함(onclick 이벤트와 동일함)
                location.href = "/user/searchUserId";
            })

            // 비밀번호 찾기
            $("#bthSearchPassword").on("click", function () { // 버튼 클릭했을때, 발생되는 이벤트 생성함(onclick 이벤트와 동일함)
...
<form id="f">
    ...
    <div>
        <button id="bthLogin" type="button">로그인</button>
        <button id="bthUserReg" type="button">회원가입</button>
        <button id="bthSearchUserId" type="button">아이디 찾기</button>
        <button id="bthSearchPassword" type="button">비밀번호 찾기</button>
    </div>
</form>
</body>
</html>
